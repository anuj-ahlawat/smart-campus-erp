...
export default function TeacherEventsPage() {
  ...
  return (
    <RoleLayout
      ...
      subtitle="View upcoming campus events, workshops, and holidays."
    >
      <Card title="Upcoming events" subtitle="Includes workshops, activities, and holiday announcements.">
        {loading ? (
